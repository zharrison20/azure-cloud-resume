...
import { BookOpen, Award, FolderGit2, FileText, Wrench } from "lucide-react";
...
type TabId = "overview" | "certifications" | "projects" | "experience" | "cv";
...
const tabs: { id: TabId; label: string; icon: typeof BookOpen; count?: number }[] = [
  ...
  { id: "experience", label: "Experience", icon: Wrench, count: 3 },
