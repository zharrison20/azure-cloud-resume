      ...
      <div className="grid gap-8 md:grid-cols-[280px_1fr] md:gap-10 items-start">
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-wrap items-center gap-x-4 gap-y-2 text-sm">
            <a href="https://github.com" target="_blank" rel="noreferrer" className="inline-flex items-center gap-1.5 text-primary hover:underline">
              <Github className="h-4 w-4" /> ZacharyHarrison
            </a>
            <a href="https://linkedin.com" target="_blank" rel="noreferrer" className="inline-flex items-center gap-1.5 text-primary hover:underline">
            ...
            <span className="inline-flex items-center gap-1.5 text-muted-foreground">
              <Building2 className="h-4 w-4" /> 24x7 I.T. Solutions
            </span>
          </div>
