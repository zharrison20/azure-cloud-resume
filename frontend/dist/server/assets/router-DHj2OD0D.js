...
const appCss = "/assets/styles-pZHiuyh6.css";
    ...
    scripts: [
      {
        ...
        children: `(function(){try{var t=localStorage.getItem('theme');if(t==='dark'||((!t||t==='system')&&matchMedia('(prefers-color-scheme:dark)').matches)){document.documentElement.classList.add('dark')}}catch(e){}})()`
      }
    ]
  }),
...
const $$splitComponentImporter = () => import("./index-dqh6CtFM.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Portfolio of Zachary Harrison — System Administrator and IT Manager based in Portland, OR. Azure, Windows Server, Active Directory, and MSP experience."
    }, {
      property: "og:title",
      content: "Zachary Harrison — System Administrator & IT Manager"
    }, {
      property: "og:description",
      content: "10+ years of IT experience: Azure, EntraID, Windows Server, AD, migrations, and team leadership."
    }, {
      property: "og:type",
      content: "profile"
    }]
