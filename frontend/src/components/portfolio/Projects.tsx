...
const projects = [
  {
    ...
    description:
      "This website! Full stack deployment hosted on Azure. Frontend/backend integration with viewcounter connecting to cosmosDB and function app, CI/CD with GitHub actions, unit testing. Full details on github link above" ,
    tech: ["Azure", "DevOps", "API", "Javascript", "Python", ],
    live: "#",
    repo: "#",
  },
  {
